...
export interface MockArtifact {
  ...
  policies: { listScenario: { enabled: boolean; itemCount: number } };
...
export interface MockEndpoint { id: string; operationId: string; method: "GET" | "POST" | "PUT" | "PATCH" | "DELETE"; path: string; summary?: string; mock: { selection: { mode: "random" | "query" | "header" | "manual"; key?: string; defaultScenario: string }; scenarios: MockScenario[] }; }

import type { ApiCodeArtifact, ApiEndpoint, MapperStep } from "../artifact/types.js";
...
export function generateEndpoint(endpoint: ApiEndpoint, transformResponse: boolean): string[] {
...
function buildDtoShape(endpoint: ApiEndpoint): DtoFieldNode {
